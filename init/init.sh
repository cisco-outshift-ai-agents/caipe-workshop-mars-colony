...
sudo cp -f $ETIPATH/labinit/update/content/init/nginx_coffee_agntcy_ui /etc/nginx/sites-enabled
sudo cp -f $ETIPATH/labinit/update/content/init/nginx_coffee_agntcy_agent /etc/nginx/sites-enabled
